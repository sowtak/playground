...
/* package working-with-persistent-0.1.0.0 */
#ifndef VERSION_working_with_persistent
#define VERSION_working_with_persistent "0.1.0.0"
#endif /* VERSION_working_with_persistent */
#ifndef MIN_VERSION_working_with_persistent
#define MIN_VERSION_working_with_persistent(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_working_with_persistent */
...
#define CURRENT_COMPONENT_ID "working-with-persistent-0.1.0.0-Gr546bIGfpmE2u6WCxYtNc-working-with-persistent"
